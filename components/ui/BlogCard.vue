  ...
  >
    ...
    <div class="p-6">
      <div class="flex items-center mb-3">
        <span
          class="inline-block py-1 px-2 rounded-full text-xs font-medium bg-primary-100 text-primary-700"
        >
          {{ post.category.name }}
        </span>
      ...
      <NuxtLinkLocale
        ...
        class="text-primary-500 font-medium inline-flex items-center hover:text-primary-600"
      >
        {{ $t("blog.readMore") }}
        <svg
          class="ml-1 w-4 h-4"
